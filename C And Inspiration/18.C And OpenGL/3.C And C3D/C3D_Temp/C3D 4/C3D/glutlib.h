...
void generateTriangleStripArrayNormals(GeometryInfo* geometryInfo)
{
	...
	{
		int coordinateIndex0=coordinateIndices==null?c:coordinateIndices[c];c++;
		int coordinateIndex1=coordinateIndices==null?c:coordinateIndices[c];c++;
		int coordinateIndex2=coordinateIndices==null?c:coordinateIndices[c];c++;
		...
		for(int j=3;j<stripCounts[i];j++)
		{
			coordinateIndex0=coordinateIndex1;
			coordinateIndex1=coordinateIndex2;
			coordinateIndex2=coordinateIndices==null?c:coordinateIndices[c];c++;
			coordinate0=coordinates[coordinateIndex0];
			coordinate1=coordinates[coordinateIndex1];
			coordinate2=coordinates[coordinateIndex2];
			if(normals[coordinateIndex2]==null)
			{
				normal=getNormal(coordinate0,coordinate1,coordinate2);
				normals[coordinateIndex2]=normal;
			}
		}
	}
	geometryInfo->normals=normals;
...
void glutTriangleStripArray(GeometryInfo* geometryInfo)
{
	Point3f** coordinates=geometryInfo->coordinates;
