...
//		case POLYGON_ARRAY:glBegin(GL_POLYGONS);break;
	...
	for(int i=0;i<vertexCount;i++)
	{
		...
		if(colors!=null)
		{
			...
			if(TransparencyAttributes_alpha<0)glColor3f(color->red,color->green,color->blue);
			else glColor4f(color->red,color->green,color->blue,TransparencyAttributes_alpha);
		}
		if(normals!=null)
		{
