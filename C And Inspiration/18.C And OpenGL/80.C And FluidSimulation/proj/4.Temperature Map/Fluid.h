...
void glUniform1I(char* uniformName, int uniformValue)
{
	GLint uniformLocation = glGetUniformLocation(glShader, uniformName);
	glUniform1i(uniformLocation, uniformValue);
}

void glUniform1F(char* uniformName, float uniformValue)
{
	GLint uniformLocation = glGetUniformLocation(glShader, uniformName);
	glUniform1f(uniformLocation, uniformValue);
}

void glUniform2F(char* uniformName, float uniformValue1, float uniformValue2)
{
	GLint uniformLocation = glGetUniformLocation(glShader, uniformName);
	glUniform2f(uniformLocation, uniformValue1, uniformValue2);
}

void glUniform3F(char* uniformName, float uniformValue1, float uniformValue2, float uniformValue3)
{
	GLint uniformLocation = glGetUniformLocation(glShader, uniformName);
