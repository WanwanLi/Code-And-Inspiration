...
GLuint solidSurfaceList;
void glutInitSolidSurfaceList()
{
	solidSurfaceList=glGenLists(1);
	glNewList(solidSurfaceList,GL_COMPILE);
	glutSolidSurface();
