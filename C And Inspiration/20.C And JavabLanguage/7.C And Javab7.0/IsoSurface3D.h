...
Shape3D* newIsoSurface3D(Value3D* value,double v)
{
	...
	m=value->row;
	n=value->column;
	isNotOnIsoSurface=new__Int(l,m,n);
	upEdgeCoordinateIndices=new__Int(l,m,n);
	leftEdgeCoordinateIndices=new__Int(l,m,n);
	frontEdgeCoordinateIndices=new__Int(l,m,n);
	upCenterEdgeCoordinateIndices=new__Int(l,m,n);
	leftCenterEdgeCoordinateIndices=new__Int(l,m,n);
	frontCenterEdgeCoordinateIndices=new__Int(l,m,n);
