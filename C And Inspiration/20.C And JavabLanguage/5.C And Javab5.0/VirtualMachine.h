...
VirtualMachine
{
	...
	List* stack;
	FILE* file;
	int functionStep0,functionStep1,functionStep2;
...
VirtualMachine* newVirtualMachine(String className)
{
	...
	virtualMachine->functionStep0=DEFAULT_FUNC_STEP;
	virtualMachine->functionStep1=DEFAULT_FUNC_STEP;
	virtualMachine->functionStep2=DEFAULT_FUNC_STEP;
...
void executeInstruction_PRINTF(VirtualMachine* virtualMachine,int* instruction)
{
	...
	int paramNumber=instruction[5],i,j,c,p=6,step=virtualMachine->functionStep0;
...
{
	Vector* v=executeInstruction_getVector(virtualMachine,instruction[1],instruction[2]);
	virtualMachine->functionStep0=(int)v->x;
	virtualMachine->functionStep1=(int)v->y;
	virtualMachine->functionStep2=(int)v->z;
	virtualMachine->instructionPointer++;
}
...
{
	int paramNumber=2,i,j,c,p=3,m=virtualMachine->functionStep0,n=virtualMachine->functionStep1;
...
{
	int paramNumber=3,k,i,j,c,p=5,n=virtualMachine->functionStep0,l=virtualMachine->functionStep1,m=virtualMachine->functionStep2;
...
{
	int i,j,m=virtualMachine->functionStep0,n=virtualMachine->functionStep1;
