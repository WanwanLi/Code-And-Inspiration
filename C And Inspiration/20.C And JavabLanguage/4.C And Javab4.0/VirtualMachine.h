...
VirtualMachine* newVirtualMachine(String className)
{
	...
	virtualMachine->functionStep=DEFAULT_FUNC_STEP;
...
void executeInstruction_OUTF(VirtualMachine* virtualMachine,int* instruction)
{
	String funcName=executeInstruction_getString(virtualMachine,instruction[1],instruction[2]);
	int paramNumber=instruction[5],i,j,c,p=6,step=virtualMachine->functionStep;
...
{
	virtualMachine->functionStep=executeInstruction_getInteger(virtualMachine,instruction[1],instruction[2]);
	virtualMachine->instructionPointer++;
}
void initExecuteInstructionTable()
{
	...
	executeInstruction[OUTF]=executeInstruction_OUTF;
