...
void getCodeLineInstructions()
{
	...
	if(w0==Word_KEY&&(w1==KeyWord_int||w1==KeyWord_double||w1==KeyWord_String||w1==KeyWord_Vector))getDeclarationInstructions(w1);
	...
	else if(w0==Word_ID&&(type==KeyWord_array||type==KeyWord_int||type==KeyWord_double||type==KeyWord_String||type==KeyWord_Object))getAssignmentInstructions();
	...
	*type=w0;
	if(w0==Word_ID)
	{
		...
		*type=identifierType;
		...
		if(identifierType==KeyWord_class||identifierType==KeyWord_Object)
		{
