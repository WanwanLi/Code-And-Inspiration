...
void getCodeLineInstructions()
{
	...
	else if(w0==Word_ID&&(type==KeyWord_array||type==KeyWord_int||type==KeyWord_double||type==KeyWord_String||type==KeyWord_Vector||type==KeyWord_Object))getAssignmentInstructions();
