...
public class JavaAndPipeline3D
{
	public static void main(String[] args)
	{
		...
		for(int i=0;i<m;i++)
		{
			double t=minT+i*dt;
			points[i]=F(t);
			sizes[i]=0.01+0.005*Math.sin(20*t);
		}
		Pipeline3D Pipeline3D=new Pipeline3D(points,sizes,Appearance1);
		TransformGroup1.addChild(Pipeline3D);
