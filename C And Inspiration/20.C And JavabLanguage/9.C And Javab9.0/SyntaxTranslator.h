...
void getThisInstructions()
{
	...
	if(w0==Word_MRK)
	{
		if(w1==Word_L_SQRBRACKET)
		{
			addIntegers(instructionsList,PUSHTG,END,LastInteger);
			instructionsLength++;
		}
		else if(w1==Word_R_SQRBRACKET)
		{
			addIntegers(instructionsList,POPTG,END,LastInteger);
			instructionsLength++;
		}
	}
	else if(w0==Word_ID)
	{
		...
		if(equals(thisMethod,"print"))
		{
			...
			{
				int type,*id=getAddInstructions(&type);
				addIntegers(instructionsList,PRINT,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
		...
		else if(equals(thisMethod,"printf"))
		{
			...
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
				{
					...
					addIntegers(instructionList,PRINTF,id0[0],id0[1],id[0],id[1],paramNumber,LastInteger);
		...
		else if(equals(thisMethod,"addLight"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)
				{
					addIntegers(instructionsList,LIGHT0,END,LastInteger);
					instructionsLength++;
					nextWord();return;
				}
				else index--;
				...
				nextWord();
				int *id1=getAddInstructions(&type);
				addIntegers(instructionsList,LIGHT,id0[0],id0[1],id1[0],id1[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setColor")||equals(thisMethod,"setDiffuseColor"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)
				{
					addIntegers(instructionsList,COLOR0,END,LastInteger);
					instructionsLength++;
					nextWord();return;
				}
				else index--;
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,COLOR,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setAcolor")||equals(thisMethod,"setAmbientColor"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ACOLOR,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setEcolor")||equals(thisMethod,"setEmissiveColor"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ECOLOR,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setScolor")||equals(thisMethod,"setSpecularColor"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,SCOLOR,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setShininess"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,SHINE,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addSphere"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,SPHERE,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addCone"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				int *id1=getAddInstructions(&type);
				addIntegers(instructionsList,CONE,id0[0],id0[1],id1[0],id1[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addCylinder"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				int *id1=getAddInstructions(&type);
				addIntegers(instructionsList,CYLINDER,id0[0],id0[1],id1[0],id1[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addBox"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,BOX,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addColorCube"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,CUBE,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"translate"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,TRANSLATE,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"rotate"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				int *id1=getAddInstructions(&type);
				addIntegers(instructionsList,ROTATE,id0[0],id0[1],id1[0],id1[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"rotX"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ROTX,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"rotY"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ROTY,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"rotZ"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ROTZ,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"scale"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,SCALE,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
				{
					...
					addIntegers(instructionList,SURF,id[0],id[1],LastInteger);
					for(i=1;i<=paramNumber;i++)addInteger(instructionList,paramPointers[i]);
					nextWord();
					for(i=0;i<paramNumber;i++)
					{
		...
		else if(equals(thisMethod,"addIsoSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
				{
					...
					Function* function=getFunction(functionList,index);
					int* paramPointers=function->paramPointers;
					int paramNumber=3,i,*id0,*id1,*idi,identifierType;
					int beginPointer=function->beginPointer;
					int endPointer=function->endPointer;
					int doublePointer=function->doublePointer;
					int vectorPointer=function->vectorPointer;
					List* instructionList=newList();
					if(function->doublePointer!=-1)id0=newID('#',doublePointer);
					else id0=newID('\\',vectorPointer);
					nextWord();
					id1=getAddInstructions(&identifierType);
					addIntegers(instructionList,ISOSURF,id1[0],id1[1],id0[0],id0[1],LastInteger);
					for(i=1;i<=paramNumber;i++)addInteger(instructionList,paramPointers[i]);
					nextWord();
					for(i=0;i<paramNumber;i++)
					{
		...
		else if(equals(thisMethod,"setColors"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				nextWord();
				if(w0==Word_KEY&&w1==KeyWord_null)
				{
					addIntegers(instructionsList,COLORS0,END,LastInteger);
					instructionsLength++;
				}
				else if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
				{
					int index=identifierTable[w1]->pointer;
					Function* function=getFunction(functionList,index);
					int* paramPointers=function->paramPointers;
					...
					addIntegers(instructionList,COLORS,id[0],id[1],LastInteger);
					for(i=1;i<=paramNumber;i++)addInteger(instructionList,paramPointers[i]);
					nextWord();
					for(i=0;i<paramNumber;i++)
					{
		...
		else if(equals(thisMethod,"setTexCoords"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				nextWord();
				if(w0==Word_KEY&&w1==KeyWord_default)
				{
					addIntegers(instructionsList,TEXCOORD,END,LastInteger);
					instructionsLength++;
				}
				else if(w0==Word_KEY&&w1==KeyWord_null)
				{
					addIntegers(instructionsList,TEXCOORD0,END,LastInteger);
					instructionsLength++;
				}
				else if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
				{
					...
					addIntegers(instructionList,TEXCOORDS,id[0],id[1],LastInteger);
					for(i=1;i<=paramNumber;i++)addInteger(instructionList,paramPointers[i]);
					nextWord();
					for(i=0;i<paramNumber;i++)
					{
		...
		else if(equals(thisMethod,"setTexture"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_KEY&&w1==KeyWord_null)
				{
					addIntegers(instructionsList,TEXTURE0,END,LastInteger);
					instructionsLength++;
				}
				else 
				{
					...
					nextWord();
					int *id2=getAddInstructions(&type);
					addIntegers(instructionsList,TEXTURE,id0[0],id0[1],id1[0],id1[1],id2[0],id2[1],END,LastInteger);
					instructionsLength++;
				}
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
		...
		else if(equals(thisMethod,"share"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				addIntegers(instructionsList,SHARE,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)getCodeBlockInstructions();
				addIntegers(instructionsList,POPTG,END,LastInteger);
				instructionsLength++;
			}
		}
		else if(equals(thisMethod,"addGroup"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				addIntegers(instructionsList,GROUP,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setTransparency"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int type,*id=getAddInstructions(&type);
				addIntegers(instructionsList,TRANSPARENCY,id[0],id[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addPolygons"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)
				{
					id0=w1;
					nextWord();
				}
				...
				addIntegers(instructionsList,POLYGONS,id0,id1,id2,END,LastInteger);
				instructionsLength++;
				nextWord();
			}
		}
		else if(equals(thisMethod,"setCtrlCount"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				int* id2=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,CTRLCOUNT,id0[0],id0[1],id1[0],id1[1],id2[0],id2[1],END,LastInteger);
				instructionsLength++;
				nextWord();
			}
		}
		else if(equals(thisMethod,"setOrder"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				int* id2=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ORDER,id0[0],id0[1],id1[0],id1[1],id2[0],id2[1],END,LastInteger);
				instructionsLength++;
				nextWord();
			}
		}
		else if(equals(thisMethod,"setKnots"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int ic0,id0,ic1,id1,ic2,id2,ik=-1;
				nextWord();
				if(w0==Word_KEY){ic0=w1;id0=ik;}
				else if(w0==Word_ID){ic0=ik;id0=w1;}
				nextWord();
				nextWord();
				if(w0==Word_KEY){ic1=w1;id1=ik;}
				else if(w0==Word_ID){ic1=ik;id1=w1;}
				nextWord();
				nextWord();
				if(w0==Word_KEY){ic2=w1;id2=ik;}
				else if(w0==Word_ID){ic2=ik;id2=w1;}
				addIntegers(instructionsList,KNOTS,ic0,id0,ic1,id1,ic2,id2,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"setWeights"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				int id=0,type;
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id=w1;
				addIntegers(instructionsList,WEIGHTS,id,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}	
		else if(equals(thisMethod,"addNurbsSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id=w1;
				addIntegers(instructionsList,NURBS,id,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addNurbsIsoSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				int* id2=getAddInstructions(&type);
				nextWord();
				addIntegers(instructionsList,ISONURBS,id,id0[0],id0[1],id1[0],id1[1],id2[0],id2[1],END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addNurbsTorus"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id=w1;
				addIntegers(instructionsList,TORNURBS,id,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addNurbsSphere"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id0=w1;
				nextWord();
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id1=w1;
				else if(w0==Word_KEY&&w1==KeyWord_null)id1=-1;
				nextWord();
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id2=w1;
				nextWord();
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id3=w1;
				addIntegers(instructionsList,SPHNURBS,id0,id1,id2,id3,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addNurbsCtrlSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id=w1;
				addIntegers(instructionsList,CTRLNURBS,id,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addLagrangeSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id=w1;
				addIntegers(instructionsList,LAGRANGE,id,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addHermiteSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				nextWord();
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_array)id=w1;
				addIntegers(instructionsList,HERMITE,id,END,LastInteger);
				instructionsLength++;
				nextWord();
				if(w0==Word_MRK&&w1==Word_R_PARENTHESE)nextWord();
			}
		}
		else if(equals(thisMethod,"addCoonsSurface"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				List* instructionList=newList();int i;
				addInteger(instructionList,COONS);
				for(i=0;i<4;i++)
				{
					nextWord();
					if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
					{
						int identifierType,*id,*id0,*id1;
						int index=identifierTable[w1]->pointer;
						Function* function=getFunction(functionList,index);
						int paramPointer=function->paramPointers[1];
						int beginPointer=function->beginPointer;
						int endPointer=function->endPointer;
						int doublePointer=function->doublePointer;
						int vectorPointer=function->vectorPointer;
						...
						addIntegers(instructionList,id[0],id[1],LastInteger);
						addInteger(instructionList,paramPointer);
						nextWord();
						id0=getAddInstructions(&identifierType);
						addIntegers(instructionList,id0[0],id0[1],LastInteger);
						nextWord();
						id1=getAddInstructions(&identifierType);
						addIntegers(instructionList,id1[0],id1[1],LastInteger);
						nextWord();
						addIntegers(instructionList,beginPointer,endPointer,LastInteger);
					}
				}
				addInteger(instructionList,END);
				mergeIntegersFromTwoLists(instructionsList,instructionList);
		...
		else if(equals(thisMethod,"addCurve3D"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				List* instructionList=newList();int i;
				addInteger(instructionList,CURVE3D);
				for(i=0;i<2;i++)
				{
					nextWord();
					if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
		...
		else if(equals(thisMethod,"addSurface3D"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				List* instructionList=newList();int i,k;
				addInteger(instructionList,SURF3D);
				for(k=0;k<3;k++)
				{
					nextWord();
					if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
		...
		else if(equals(thisMethod,"addMesh3D"))
		{
			nextWord();
			if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
			{
				...
				if(w0==Word_ID&&identifierTable[w1]->type==KeyWord_func)
				{
					...
					addIntegers(instructionList,MESH3D,id[0],id[1],LastInteger);
					for(i=1;i<=paramNumber;i++)addInteger(instructionList,paramPointers[i]);
					nextWord();
					for(i=0;i<paramNumber;i++)
					{
					...
					int identifierType;id=getAddInstructions(&identifierType);
					addIntegers(instructionList,beginPointer,endPointer,id[0],id[1],END,LastInteger);
					mergeIntegersFromTwoLists(instructionsList,instructionList);
					instructionsLength++;
				}
				else index--;
...
int* getThisIdentifierInstructions(int* type)
{
	...
	if(equals(thisMethod,"nextInt")||equals(thisMethod,"nextDouble")||equals(thisMethod,"next")||equals(thisMethod,"nextLine")||equals(thisMethod,"nextVector"))
	{
		...
		if(w0==Word_MRK&&w1==Word_L_PARENTHESE)
		{
			...
			if(w0==Word_MRK&&w1==Word_R_PARENTHESE)
			{
				...
				addIntegers(instructionsList,SCAN,id[0],id[1],END,LastInteger);
				instructionsLength++;
				return id;
			}
		}
	...
	else if(equals(thisMethod,"PI"))
	{
		*type=KeyWord_double;
		...
		addIntegers(instructionsList,MOVPI,id[0],id[1],END,LastInteger);
		instructionsLength++;
		return id;
	}
