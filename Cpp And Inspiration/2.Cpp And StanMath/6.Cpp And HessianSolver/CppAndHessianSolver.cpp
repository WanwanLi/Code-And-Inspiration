...
typedef stan::math::fvar<stan::math::var> var;
...
double f(const VectorXd& arg, VectorXd& grad, MatrixXd& hess)
{
	VectorXd v(2); v<<-2, 2; Functor functor(v); double val;
	stan::math::hessian(functor, arg, val, grad, hess); return val;
}
