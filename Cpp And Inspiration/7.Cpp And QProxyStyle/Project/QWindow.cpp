...
QWindow::QWindow(QWidget* widget) : QWidget(widget)
{
	...
	this->itemList<<"wood"<<"snow";
	this->itemList<<"grass"<<"flame";
	this->itemList<<QStyleFactory::keys();
	...
	connect(comboBox, SIGNAL(activated(QString)), this, SLOT(activated(QString)));
}
...
void QWindow::activated(QString text)
{
	QStyle* style;
