...
class QStrokes
{
	...
	void minimizeDepth(QVector3D position, qreal& depth, int plane);
	...
	bool intersectDepthPath(QVector<qreal>& positions, QVector<bool>& isDeleted, int index0, int index1);
