...
QMenuBar* QWindow::newQMenuBar()
{
	...
	action=menu->addAction("Visualize", canvas, &QCanvas::visualize, QKeySequence(tr("Ctrl+v")));
	...
	action=menu->addAction("Depth", canvas, &QCanvas::depth, QKeySequence(tr("Ctrl+d")));
