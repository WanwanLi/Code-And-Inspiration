import java.awt.*;
import java.applet.*;
public class JavaAndColorfulTree extends Applet
{
	...
	private static void getColorfulTreeQuads()
	{
		...
		for(int i=0;i<MaxDepth;i++)
		{
			...
			for(int j=0;j<length;j++)
			{
				...
				quad0.color=new Color(0,200,0);
				quad1.color=new Color(0,200,200);
				quad2.color=new Color(0,0,200);
				quad3.color=new Color(200,200,0);
				queue.enQueue(quad0);
				queue.enQueue(quad1);
				queue.enQueue(quad2);
				queue.enQueue(quad3);
