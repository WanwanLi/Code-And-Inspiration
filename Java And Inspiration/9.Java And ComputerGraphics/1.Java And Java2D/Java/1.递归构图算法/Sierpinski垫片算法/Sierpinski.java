...
public class Sierpinski extends Applet
{
	public void paint(Graphics g)
	{
		try
		{
			...
			drawSierpinskiShape(g,300,300,500);
		}
	...
	private void drawSierpinskiShape(Graphics g,double x,double y,double L)
	{	
		double xA=x-L/2;
		...
		if(L>10)
		{
			...
			drawSierpinskiShape(g,x1,y1,L/2);
			drawSierpinskiShape(g,x2,y2,L/2);
			drawSierpinskiShape(g,x3,y3,L/2);	
		} 
	}
}
