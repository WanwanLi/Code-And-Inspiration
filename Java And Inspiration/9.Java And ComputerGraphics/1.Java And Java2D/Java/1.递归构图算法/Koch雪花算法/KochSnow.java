...
public class KochSnow extends Applet
{
	...
	{
		drawKochShape(g,x+2*radius,y+2*radius,x+2*radius*Math.cos(PI/3),y);
		drawKochShape(g,x+2*radius*Math.cos(PI/3),y,x,y+2*radius);
		drawKochShape(g,x,y+2*radius,x+2*radius,y+2*radius);
	}
