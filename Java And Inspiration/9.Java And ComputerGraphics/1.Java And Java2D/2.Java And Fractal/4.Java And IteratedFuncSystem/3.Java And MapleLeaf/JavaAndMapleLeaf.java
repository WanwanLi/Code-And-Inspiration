...
public class JavaAndMapleLeaf 
{
	public static void main(String[] args)
	{
		Frame_MapleLeaf Frame_MapleLeaf1=new Frame_MapleLeaf();
		Frame_MapleLeaf1.setVisible(true);
	}
}
class Frame_MapleLeaf extends Frame
{
	...
	int sizeX=500;
	int sizeY=500;
	public Frame_MapleLeaf()
	{
		IFS[0]=new IFSCode(0.6,0,0,0.6,0.18,0.12,sizeX,sizeY);
		IFS[1]=new IFSCode(0.6,0,0,0.6,0.18,0.36,sizeX,sizeY);
		IFS[2]=new IFSCode(0.4,0.3,-0.3,0.4,0.27,0.36,sizeX,sizeY);
		IFS[3]=new IFSCode(0.4,-0.3,0.3,0.4,0.27,0.09,sizeX,sizeY);
		queue=new QuadQueue();
		queue.enQueue(0,0,sizeX,0,sizeX,sizeY,0,sizeY,new Color(255,0,0));
		getMapleLeafQuads();
	...
	private static void getMapleLeafQuads()
	{
