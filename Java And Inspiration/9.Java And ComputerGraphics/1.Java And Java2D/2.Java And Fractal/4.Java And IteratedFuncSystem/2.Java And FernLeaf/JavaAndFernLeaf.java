...
public class JavaAndFernLeaf 
{
	public static void main(String[] args)
	{
		Frame_FernLeaf Frame_FernLeaf1=new Frame_FernLeaf();
		Frame_FernLeaf1.setVisible(true);
	}
}
class Frame_FernLeaf extends Frame
{
	...
	int sizeX=40;
	int sizeY=60;
	public Frame_FernLeaf()
	{
		IFS[0]=new IFSCode(0,0,0,0.16,0,0,sizeX,sizeY);
		IFS[1]=new IFSCode(0.85,0.04,-0.04,0.85,0,1.6,sizeX,sizeY);
		IFS[2]=new IFSCode(0.2,-0.26,0.23,0.22,0,1.6,sizeX,sizeY);
		IFS[3]=new IFSCode(-0.15,0.28,0.46,0.24,0,0.44,sizeX,sizeY);
		queue=new QuadQueue();
	...
	private static void getFernLeafQuads()
	{
