...
public class JavaAndMandelbrotSet 
{
	...
	{
		int w=1380,h=780;
		double p0=-2.4,q0=-1.2,p1=1.2,q1=1.2;
		Frame_MandelbrotSet Frame_MandelbrotSet1=new Frame_MandelbrotSet(p0,q0,p1,q1,w,h);
...
class Frame_MandelbrotSet extends Frame
{
	...
	public Frame_MandelbrotSet(double p0,double q0,double p1,double q1,int width,int height)
	{
		this.minP=p0;
		this.minQ=q0;
		this.maxP=p1;
