...
public class JavaAndRayTracer
{
	public static void main(String[] args) throws Exception
	{
		...
		int imageWidth=700, imageHeight=700, maxTime=100;
		System.out.println("Ray tracing Started: "+(new Date()).toString());
		RayTracer RayTracer1=new RayTracer(imageWidth, imageHeight);
		RayTracer1.renderImage(viewConf, lightConf, maxTime);
		System.out.println("Ray tracing finished: "+(new Date()).toString());
		String fileName="result-"+imageWidth+"x"+imageHeight;
		BufferedImage BufferedImage1=RayTracer1.getBufferedImage();
		ImageIO.write(BufferedImage1,"JPG",new File(fileName+".jpg"));
		System.out.println("Image output: "+fileName+" is done...");
	}
}
class vec3
{
