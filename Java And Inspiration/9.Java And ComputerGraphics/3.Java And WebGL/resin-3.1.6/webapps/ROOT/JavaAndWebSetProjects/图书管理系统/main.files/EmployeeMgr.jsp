...
<DIV>
  ...
  height=47>
    ...
    vAlign=top align=middle>
      ...
      border=1>
      <jsp:useBean id="teacherDao1" class="DAO.teacherDao" scope="page"/>
      <% 
      ResultSet ResultSet1= teacherDao1.getTeacherResultSet("select * from teacher");%>
              <TBODY>
                <TR>
                ...
                while(ResultSet1.next())
                {
                	...
                	int Tage=ResultSet1.getInt("Tage");
                %>
                <Tr>
                  <TD class=gridViewItem style="WIDTH: 50px"><IMG 
            src="EmployeeMgr.files/bg_users.gif"> </TD>
                  <TD class=gridViewItem><%= Tid %>></TD>
                  <TD class=gridViewItem><%= Tname %>></TD>
                  <TD class=gridViewItem><%=Tage %>></TD>
