...
<Html>
	...
	<Body BGColor=Black Text=White Link=White ALink=Purple >
		...
		<%
			...
			String s=BufferedReader1.readLine();while(s!=null){out.print(s+"<Br>");s=BufferedReader1.readLine();}
			...
			<Table Align=Center BackGround=W.jpg Border=1 Width=500 Height=500 BorderColor=Purple >
				...
				<Tr>				
					<Td Align=Center ColSpan=3>
					        <jsp:useBean id="Bean1" class="JavaBeanPrograming.JavaBean1" scope="page"/>
					        <Center>
						      <% Bean1.setString("Bean1");%> Bean1=<%= Bean1.getString()%><Br>
						      ALink1=<%= Bean1.getALink("H.html") %><Br>
						      Image1=<%= Bean1.getImage("W.jpg") %><Br>
						      readFile=<%= Bean1.readFile("Text1.txt")%><Br>
