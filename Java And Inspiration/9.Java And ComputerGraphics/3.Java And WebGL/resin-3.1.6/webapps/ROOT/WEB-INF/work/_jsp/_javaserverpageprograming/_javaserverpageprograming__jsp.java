...
package _jsp._javaserverpageprograming;
...
public class _javaserverpageprograming__jsp extends com.caucho.jsp.JavaPage
{
  private static final java.util.HashMap<String,java.lang.reflect.Method> _jsp_functionMap = new java.util.HashMap<String,java.lang.reflect.Method>();
  private boolean _caucho_isDead;

   String String1="JavaServerPagePrograming"; 
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      out.write(_jsp_string3, 0, _jsp_string3.length);
			...
			if(Strings!=null&&Strings[0]!=null)
				...
				else if(Strings[0].equals("Option3"))
				{
					...
					int i=BufferedImage.TYPE_INT_RGB;					
				         	BufferedImage BufferedImage1=new BufferedImage(300,300,i);
					Graphics g=BufferedImage1.getGraphics();
					g.setColor(Color.black);
					g.fillRect(0,0,500,500);												g.dispose();
      ...
      out.write(_jsp_string20, 0, _jsp_string20.length);
			...
			{		
				Object o=session.getAttribute("FileName");
				OutputStream OutputStream1=response.getOutputStream();				
				byte[] bytes=new byte[1024];
				File1=new File(request.getRealPath("./Submit Files")+"\\"+(String)o);
				response.setHeader("content-disposition","attachment;filename="+(String)o);
				response.setContentType("application/x-tar");
				response.setHeader("Content_Length",String.valueOf(File1.length()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("JavaServerPagePrograming/JavaServerPagePrograming.jsp"), 3885800952790064L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("JavaServerPagePrograming/\u58f0\u660e.txt"), -4794295078946225980L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
  ...
  static {
    _jsp_string1 = "\r\n		<H1><B>".toCharArray();
    _jsp_string19 = "\"><B>Image File Submited is:</B>\r\n			</A><Br><Image Src=\"Submit Files\\".toCharArray();
    _jsp_string5 = "<Br>\r\n			Text1:".toCharArray();
    _jsp_string2 = "</B></H1><Br>\r\n		<B>".toCharArray();
    _jsp_string12 = " Bean1=".toCharArray();
    _jsp_string15 = "<Br>						      			      readFile=".toCharArray();
    ...
    _jsp_string13 = "<Br>\r\n						      ALink1=".toCharArray();
    _jsp_string22 = "    int1=".toCharArray();
    ...
    _jsp_string24 = " LastAccessedTime:".toCharArray();
    _jsp_string11 = "						        <Center>\r\n						      ".toCharArray();
