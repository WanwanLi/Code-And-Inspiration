...
Vector3.prototype.normal=function(v0,v1,v2)
{
	var v01=new Vector3(v1.elements);v01.sub(v0);
	var v12=new Vector3(v2.elements);v12.sub(v1);
	this.cross(v01,v12);
	this.normalize();
};
...
Vector3.prototype.println=function()
{
	var v=this.elements;
	console.log("<"+v[0]+","+v[1]+","+v[2]+">");
};
