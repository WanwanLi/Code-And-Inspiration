...
{
	var v=this.elements,dv=0.001;
	v[0]=2.0*(dv+Math.random())-1.0;
	v[1]=2.0*(dv+Math.random())-1.0;
	v[2]=2.0*(dv+Math.random())-1.0;
}
Vector3.prototype.vertical=function()
{
...
Vector3.prototype.sum=function(param)
{
	var v=this.xyz();
	var v0=v.elements;
	var v1=param.elements;
...
Vector3.prototype.crossProduct=function(param)
{
	var v0=this.elements;
	var v1=param.elements;
	var x0=v0[0], y0=v0[1], z0=v0[2];
...
Vector3.prototype.minus=function(param)
{
	var v=this.xyz();
	var v0=v.elements;
	var v1=param.elements;
