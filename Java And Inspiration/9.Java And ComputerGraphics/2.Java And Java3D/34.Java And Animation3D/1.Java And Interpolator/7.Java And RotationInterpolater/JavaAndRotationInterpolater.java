...
public class JavaAndRotationInterpolater
{
	public static void main(String[] args)
	{
		...
		TransformGroup TransformGroupClock=new TransformGroup(transform3D);
		TransformGroupClock.addChild(new Sphere(r,2,100,Appearance1));
		TransformGroup1.addChild(TransformGroupClock);
		...
		Appearance3.setTexture((new TextureLoader("Pendulum.jpg",null)).getTexture());
		transform3D=new Transform3D();
		transform3D.setTranslation(new Vector3f(0f,-r,-0.025f));
		TransformGroup TransformGroup2=new TransformGroup(transform3D);
		TransformGroup2.addChild(new Cylinder(0.005f,r/2,Appearance2));
		transform3D.setTranslation(new Vector3f(0f,-1.5f*r,-0.025f));
		transform3D.setScale(new Vector3d(1,1,0.02));
		TransformGroup TransformGroup3=new TransformGroup(transform3D);
		TransformGroup3.addChild(new Sphere(r/4,2,100,Appearance3));
		TransformGroup TransformGroupPendulum=new TransformGroup();
		TransformGroupPendulum.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
		TransformGroupPendulum.addChild(TransformGroup2);
		TransformGroupPendulum.addChild(TransformGroup3);
		TransformGroup1.addChild(TransformGroupPendulum);
		Alpha Alpha1=new Alpha();
		Alpha1.setLoopCount(-1);
		Alpha1.setIncreasingAlphaDuration(1000);
		Alpha1.setDecreasingAlphaDuration(1000);
		Alpha1.setMode(Alpha.INCREASING_ENABLE|Alpha.DECREASING_ENABLE);
		transform3D=new Transform3D();
		transform3D.rotX(Math.PI/2);
		RotationInterpolator RotationInterpolator1=new RotationInterpolator(Alpha1,TransformGroupPendulum,transform3D,-(float)Math.PI/6,(float)Math.PI/6);
		RotationInterpolator1.setSchedulingBounds(BoundingSphere1);
		BranchGroup1.addChild(RotationInterpolator1);
