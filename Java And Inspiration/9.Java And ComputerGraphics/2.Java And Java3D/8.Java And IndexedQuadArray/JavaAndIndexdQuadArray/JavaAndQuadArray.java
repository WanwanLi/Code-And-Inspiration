...
public class JavaAndQuadArray
{
	public static void main(String[] args)
	{
		...
		System.out.println(QuadArray.COORDINATES|QuadArray.COLOR_3);
		QuadArray QuadArray1=new QuadArray(number,5);
		QuadArray1.setCoordinates(0,Coordinates);
		QuadArray1.setColors(0,Colors);
