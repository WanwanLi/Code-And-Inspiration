...
public class JavaAndSharedGroup
{
	public static void main(String[] args)
	{
		...
		TransformGroup TransformGroup16=new TransformGroup();
		TransformGroup16.addChild(TransformGroup2);
		TransformGroup16.addChild(TransformGroup3);
		TransformGroup16.addChild(TransformGroup4);
		TransformGroup16.addChild(TransformGroup5);
		TransformGroup16.addChild(TransformGroup6);
		TransformGroup16.addChild(TransformGroup7);
		TransformGroup16.addChild(TransformGroup8);
		TransformGroup16.addChild(TransformGroup9);
		TransformGroup16.addChild(TransformGroup10);
		TransformGroup16.addChild(TransformGroup11);
		TransformGroup16.addChild(TransformGroup12);
		TransformGroup16.addChild(TransformGroup13);
		TransformGroup16.addChild(TransformGroup15);
		SharedGroup SharedGroup1=new SharedGroup();
		SharedGroup1.addChild(TransformGroup16);
		transform3D.setScale(0.5);
		TransformGroup TransformGroup17=new TransformGroup(transform3D);
		TransformGroup17.addChild(new Link(SharedGroup1));
		TransformGroup1.addChild(TransformGroup17);
		transform3D=new Transform3D();
		transform3D.setScale(0.25);
		transform3D.setTranslation(new Vector3f(-0.5f,-0.25f,0f));
		TransformGroup TransformGroup18=new TransformGroup(transform3D);
		TransformGroup18.addChild(new Link(SharedGroup1));
		TransformGroup1.addChild(TransformGroup18);
