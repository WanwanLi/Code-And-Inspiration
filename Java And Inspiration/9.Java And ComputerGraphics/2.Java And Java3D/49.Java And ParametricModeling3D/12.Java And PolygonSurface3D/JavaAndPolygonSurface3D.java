...
public class JavaAndPolygonSurface3D
{
	public static void main(String[] args)
	{
		...
		PolygonSurface3D polygonSurface3D=new PolygonSurface3D(P[0][0],P[0][1],P[1][0],P[1][1],coordinatesUV);
...
class PolygonSurface3D extends Shape3D
{
	...
	public PolygonSurface3D(Point3d point00,Point3d point01,Point3d point10,Point3d point11,double[] coordinatesUV)
	{
		this.P00=point00;
		this.P10=point10;
		this.P11=point11;
