...
public class JavaAndMaterial3D
{
	public static void main(String[] args)
	{
		...
		//TransformGroup1.addChild(new IsoSurface3D(value3D,0.5,true,colorSpace3D));
		//TransformGroup1.addChild(new IsoSurface3D(value3D,0.5,true,wood3D));
		TransformGroup1.addChild(new IsoSurface3D(value3D,0.5,true,marble3D));
