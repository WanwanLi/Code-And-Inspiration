...
class Frame_Polygon extends Frame
{
	...
	public Frame_Polygon()
	{
		...
		try
		{
			Image1=Toolkit.getDefaultToolkit().getImage("Images\\Bishop.jpg");
			...
			//ImageOp1.printPolygon(polygon,0.005,-0.88-0.27,-1.25+3.775); //King
			//ImageOp1.printPolygon(polygon,0.005,-1.115,0.475+2.19); //Queen
			//ImageOp1.printPolygon(polygon,0.005,-1.14,2.455); //Bishop
			//ImageOp1.printPolygon(polygon,0.005,-1.14,2.455); //Knight
			//ImageOp1.printPolygon(polygon,0.005,-1.18,2.59); //Rook
			//ImageOp1.printPolygon(polygon,0.005,0.03-1.195,2.56); //Pawn
