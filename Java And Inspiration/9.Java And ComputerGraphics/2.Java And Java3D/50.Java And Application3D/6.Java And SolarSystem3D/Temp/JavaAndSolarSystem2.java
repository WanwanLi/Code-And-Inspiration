...
class SolarSystem extends TransformGroup
{
	...
	{
		this.SphereInfoTable[Mercury]=new SphereInfo("Mercury",0.045f,0.4,0.2,0.0,0.0,5000,8000);
		this.SphereInfoTable[Venus]=new SphereInfo("Venus",0.08f,0.8,0.4,0.0,0.0,8000,5000);
		this.SphereInfoTable[Earth]=new SphereInfo("Earth",0.1f,1.2,1.0,0.0,Math.PI/10,10000,3000);
		this.SphereInfoTable[Moon]=new SphereInfo("Moon",0.03f,0.2,0.2,0.0,0.0,4000,4000);
		this.SphereInfoTable[Mars]=new SphereInfo("Mars",0.1f,1.4,1.25,0.0,0.0,11000,4000);
