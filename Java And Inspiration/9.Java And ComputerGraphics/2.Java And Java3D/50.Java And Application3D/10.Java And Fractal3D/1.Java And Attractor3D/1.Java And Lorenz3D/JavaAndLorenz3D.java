...
public class JavaAndLorenz3D extends Applet
{
	public void init()
	{
		...
		transform3D.setScale(new Vector3d(0.25,0.25,0.25));
		...
		TransformGroup1.addChild(new Lorenz3D(Appearance1));
	...
	{
		new MainFrame(new JavaAndLorenz3D(),400,400);
	}
}
class Lorenz3D extends Shape3D
{
	...
	public Lorenz3D(Appearance appearance)
	{
