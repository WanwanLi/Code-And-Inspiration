...
public class JavaAndRossler3D extends Applet
{
	public void init()
	{
	...
	{
		new MainFrame(new JavaAndRossler3D(),400,400);
	}
}
class Rossler3D extends Shape3D
{
	...
	public Rossler3D(Appearance appearance)
	{
