	...
	private int getCoordinateIndicesCount()
	{
		...
		for(int k=0;k<l-1;k++)
		{
			for(int i=0;i<m-1;i++)
			{
				...
				{
/*
frontEdgeCoordinateIndices[k][i][j]!=-1
upEdgeCoordinateIndices[k][i][j]!=-1
leftEdgeCoordinateIndices[k][i][j]!=-1
upCenterEdgeCoordinateIndices[k][i][j]!=-1
leftCenterEdgeCoordinateIndices[k][i][j]!=-1
frontCenterEdgeCoordinateIndices[k][i][j]!=-1
*/
