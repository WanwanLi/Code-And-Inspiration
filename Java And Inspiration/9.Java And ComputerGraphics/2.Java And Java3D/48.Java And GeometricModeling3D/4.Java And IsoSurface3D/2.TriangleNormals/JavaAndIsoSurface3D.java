...
public class JavaAndIsoSurface3D
{
	public static void main(String[] args)
	{
		...
		double r=1.2;
		Value3D value3D=new Value3D(new Function_Value5(),-r,r,-r,r,-r,r);
		Material Material1=new Material();
		Material1.setDiffuseColor(new Color3f(0,1,0));
		Appearance Appearance1=new Appearance();
		Appearance1.setMaterial(Material1);
		IsoSurface3D isoSurface3D=new IsoSurface3D(value3D,1.0,Appearance1);
...
class Value3D
{
	...
	public int level=80,row=80,column=80;
...
class IsoSurface3D extends Shape3D
{
	...
	public IsoSurface3D(Value3D value,double v,Appearance appearance)
	{
		this.v=v;
		this.x0=value.x0;
		this.y0=value.y0;
