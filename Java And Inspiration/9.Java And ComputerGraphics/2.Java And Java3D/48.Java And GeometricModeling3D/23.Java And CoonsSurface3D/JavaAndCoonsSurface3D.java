...
/*		TransformGroup1.addChild(new Curve3D(pU0));
		TransformGroup1.addChild(new Curve3D(pU1));
		TransformGroup1.addChild(new Curve3D(p0V));
		TransformGroup1.addChild(new Curve3D(p1V));*/
