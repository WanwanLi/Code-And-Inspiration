...
public class JavaAndTriangleStripArray
{
	public static void main(String[] args)
	{
		...
		int[] numberOfEachPolygon=new int[]{5,4};
		Shape3D shape3D=new Shape3D();
		System.out.println(TriangleStripArray.COORDINATES|TriangleStripArray.COLOR_3);
		TriangleStripArray TriangleStripArray1=new TriangleStripArray(number,5,numberOfEachPolygon);
		TriangleStripArray1.setCoordinates(0,Coordinates);
		TriangleStripArray1.setColors(0,Colors);
		...
		shape3D.setGeometry(TriangleStripArray1);
