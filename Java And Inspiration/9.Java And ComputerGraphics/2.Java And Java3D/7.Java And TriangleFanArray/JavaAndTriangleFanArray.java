...
public class JavaAndTriangleFanArray
{
	public static void main(String[] args)
	{
		...
		System.out.println(TriangleFanArray.COORDINATES|TriangleFanArray.COLOR_3);
		TriangleFanArray TriangleFanArray1=new TriangleFanArray(number,5,numberOfEachPolygon);
		TriangleFanArray1.setCoordinates(0,Coordinates);
		TriangleFanArray1.setColors(0,Colors);
