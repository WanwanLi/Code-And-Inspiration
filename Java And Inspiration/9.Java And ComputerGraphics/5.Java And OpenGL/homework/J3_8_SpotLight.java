...
public class J3_8_SpotLight extends J3_7_MoveLight {
  ...
  public void drawSolar(float E, float e, float M, float m) {
    ...
    gl.glLightf(GL2.GL_LIGHT0, GL2.GL_SPOT_CUTOFF, 20f);
    gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_SPOT_DIRECTION,
                 spot_direction,0); // facing x axis initially
    gl.glLightf(GL2.GL_LIGHT0, GL2.GL_SPOT_EXPONENT, 2f);
    gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION, origin,0);
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_EMISSION, whitish,0);
    drawSphere();
