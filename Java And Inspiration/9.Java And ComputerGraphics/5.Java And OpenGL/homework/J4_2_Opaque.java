...
public class J4_2_Opaque extends J4_1_Blending {
  ...
  public void drawSolar(float E, float e,
    ...
    gl.glPushMatrix();
    {
      ...
      gl.glPushMatrix();
      {
        ...
        gl.glLightfv(GL2.GL_LIGHT1,
                     GL2.GL_SPOT_DIRECTION, spot_direction,0);
        gl.glLightf(GL2.GL_LIGHT1, GL2.GL_SPOT_CUTOFF, 5);
      ...
      gl.glPushMatrix();
      {
        ...
        gl.glLightfv(GL2.GL_LIGHT2,
                     GL2.GL_SPOT_DIRECTION, spot_direction,0);
        gl.glLightf(GL2.GL_LIGHT2, GL2.GL_SPOT_CUTOFF, 10f);
      ...
      gl.glLightfv(GL2.GL_LIGHT3,
                   GL2.GL_SPOT_DIRECTION, spot_direction,0);
      gl.glLightf(GL2.GL_LIGHT3, GL2.GL_SPOT_CUTOFF, 15f);
      drawColorCoord(WIDTH/4, WIDTH/4, WIDTH/4);
    ...
    gl.glDisable(GL2.GL_BLEND); // no blending afterwards
