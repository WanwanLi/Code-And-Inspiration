...
public class J4_8_Mipmap extends J4_7_TexObjects {
  ...
  public void init(GLAutoDrawable glDrawable) {
    ...
    gl.glBindTexture(GL2.GL_TEXTURE_2D, IRIS_TEX[0]);
    ...
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_128_128.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 1, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_64_64.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 2, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_32_32.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 3, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_16_16.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 4, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_8_8.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 5, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_4_4.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 6, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_2_2.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 7, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));

    readImage("IRIS1_1_1.JPG");
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 8, GL2.GL_RGB8,
                    imgW, imgH, 0, GL2.GL_BGR,
                    GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(img));
