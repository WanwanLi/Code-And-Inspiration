...
public class J3_6_Materials extends J3_5_Specular {
  ...
  public void init(GLAutoDrawable glDrawable) {
    ...
    gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_AMBIENT, whitish,0);
    ...
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_DIFFUSE, whitish,0);
  ...
  public void drawColorCoord(float xlen,
    ...
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_EMISSION, red,0);
    gl.glColor3f(1, 0, 0);
    gl.glVertex3f(0, 0, 0);
    gl.glVertex3f(0, 0, zlen);
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_EMISSION, green,0);
    gl.glColor3f(0, 1, 0);
    gl.glVertex3f(0, 0, 0);
    gl.glVertex3f(0, ylen, 0);
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_EMISSION, blue,0);
    gl.glColor3f(0, 0, 1);
    gl.glVertex3f(0, 0, 0);
