...
public class JavaAndGLClipPlane
{
	public static void main(String[] args) 
	{
		GLCanvas canvas = new GLCanvas();
		GLDrawableListener listener = new GLDrawableListener();
		final Frame frame = new Frame("Java And GLClipPlane");
...
class GLDrawableListener implements GLEventListener 
{
	...
	vec3 clippingSpace = new vec3(0.8, 0.4, 0.6);
	double[] plane0 = {0, 1, 0, -100}, plane1 = {0, -1, 0, 200}, plane2 = {1, 0, 0,200};
	...
	public void display(GLAutoDrawable drawable) 
	{
		...
		gl.glClipPlane(GL2.GL_CLIP_PLANE0, plane0, 0);
		gl.glClipPlane(GL2.GL_CLIP_PLANE1, plane1, 0);
		gl.glClipPlane(GL2.GL_CLIP_PLANE2, plane2, 0);
	}
