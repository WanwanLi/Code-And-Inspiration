...
public class JavaAndJsonParser
{
...
class JsonParser
{
	...
	void addDataItem(String string)
	{
		...
		for(int i=0; i<dataItemTable.length; i++)
		{
			this.dataItemTable[i].add(dataItem[i]);
		}
	}
	String getAttributeValuePair(String attribute, String value)
	{
		String l="\""; return l+attribute+l+" : " +l+(isDateType(attribute)?parseDate(value):value)+l;
	}
