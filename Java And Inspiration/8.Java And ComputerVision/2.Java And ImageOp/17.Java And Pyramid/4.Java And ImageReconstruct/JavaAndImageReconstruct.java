...
public class JavaAndImageReconstruct
{
	public static void main(String[] args)
	{
		Frame_ImageReconstruct Frame_ImageReconstruct1=new Frame_ImageReconstruct();
		Frame_ImageReconstruct1.setVisible(true);
	}
}
class Frame_ImageReconstruct extends Frame
{
	...
	public Frame_ImageReconstruct()
	{
		...
		try
		{
			...
			double u1=0,u2=0,o1=sgm,o2=sgm,p=0,zoom=0.55;
			...
			this.Image2=this.createImage(ImageOp1.reconstructImage(pyramidPixels,imageWidths[0],imageHeights[0],GaussFilter));
		}
