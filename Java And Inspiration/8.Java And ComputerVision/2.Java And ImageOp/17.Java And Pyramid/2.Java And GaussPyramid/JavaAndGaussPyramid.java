...
public class JavaAndGaussPyramid
{
	public static void main(String[] args)
	{
		Frame_GaussPyramid Frame_GaussPyramid1=new Frame_GaussPyramid();
		Frame_GaussPyramid1.setVisible(true);
	}
}
class Frame_GaussPyramid extends Frame
{
...
//			ImageOp1.filter(GaussFilter);
			int level=4;
			int[][] pyramidPixels=ImageOp1.getReducedPyramidPixels(GaussFilter,level);
			...
			pyramidPixels=ImageOp2.getExpandedPyramidPixels(GaussFilter,level);
...
//	if(Image2!=null)g.drawImage(Image2,50+imageWidth,100,this);
	}
}
class ImageOp
{
