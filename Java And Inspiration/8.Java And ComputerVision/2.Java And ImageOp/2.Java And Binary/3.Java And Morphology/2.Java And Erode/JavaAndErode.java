...
public class JavaAndErode
{
	public static void main(String[] args)
	{
		Frame_Erode Frame_Erode1=new Frame_Erode();
		Frame_Erode1.setVisible(true);
	}
}
class Frame_Erode extends Frame
{
	...
	public Frame_Erode()
	{
		...
		try
		{
			...
			ImageOp1.erodeFilter(Filter,Color.black,Color.white,150);
...
class ImageOp
{
	...
	public void erodeFilter(int[][] Filter,Color foregroundColor,Color backgroundColor,int thresholdValue)
	{
		int[] binaryValues=this.getBinaryValues(thresholdValue);
