...
class Frame_SobelFilter extends Frame
{
	...
	public Frame_SobelFilter()
	{
		...
		try
		{
			...
			double[][] SobelFilter=ImageOp1.getSobelFilter(true);
			ImageOp1.filter(SobelFilter);
		//	double[][] PrewittFilter=ImageOp1.getPrewittFilter(false);
		//	ImageOp1.filter(PrewittFilter);
...
class ImageOp
{
	...
	public double[][] getSobelFilter(boolean isVerticalEdge)
	{
		if(isVerticalEdge)
		{
			return new double[][]
	...
	public double[][] getPrewittFilter(boolean isVerticalEdge)
	{
		if(isVerticalEdge)
		{
			return new double[][]
