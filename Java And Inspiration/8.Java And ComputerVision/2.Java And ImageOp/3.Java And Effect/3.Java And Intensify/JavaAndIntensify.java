...
public class JavaAndIntensify
{
	public static void main(String[] args)
	{
		Frame_Intensify Frame_Intensify1=new Frame_Intensify();
		Frame_Intensify1.setVisible(true);
	}
}
class Frame_Intensify extends Frame
{
	public Image Image1,Image2;
	int imageWidth,imageHeight;
	public Frame_Intensify()
	{
		...
		try
		{
			...
			ImageOp1.intensify(contrast,brightness);
...
class ImageOp
{
	...
	public void intensify(double contrast,double brightness)
	{
		...
		for(int i=0;i<ImageHeight;i++)
		{
			for(int j=0;j<ImageWidth;j++)
			{
				...
				double Alpha=alpha;
				double Red=red*contrast+brightness;
				double Green=green*contrast+brightness;
				double Blue=blue*contrast+brightness;
