...
public class JavaAndEqualize
{
	public static void main(String[] args)
	{
		Frame_Equalize Frame_Equalize1=new Frame_Equalize();
		Frame_Equalize1.setVisible(true);
	}
}
class Frame_Equalize extends Frame
{
	public Image Image1,Image2;
	int imageWidth,imageHeight;
	Histogram Histogram1;
	public Frame_Equalize()
	{
	...
	public void equalize()
	{
		...
		for(int i=0;i<ImageHeight;i++)
		{
			for(int j=0;j<ImageWidth;j++)
			{
				...
				double hue=HSB[0],saturation=HSB[1];
				double brightness=Histogram[brightnessValues[i*ImageWidth+j]];
