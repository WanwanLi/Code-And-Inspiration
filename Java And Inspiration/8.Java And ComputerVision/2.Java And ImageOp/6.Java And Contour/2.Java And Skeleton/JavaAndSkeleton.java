...
public class JavaAndSkeleton
{
	public static void main(String[] args)
	{
		Frame_Skeleton Frame_Skeleton1=new Frame_Skeleton();
		Frame_Skeleton1.setVisible(true);
	}
}
class Frame_Skeleton extends Frame
{
	public Image Image1,Image2;
	int imageWidth,imageHeight,i=0,j=0;
	public Frame_Skeleton()
	{
