...
public class JavaAndAirplaneGame
{
	...
	{
		new JFrame_AirplaneGame(args[0]);
	}
}
class JFrame_AirplaneGame extends JFrame implements KeyListener,MouseListener,MouseMotionListener
{
	private final int X=0,Y=1,LOSS=0,HIT=1,RUIN=2,END=3;
	...
	public JFrame_AirplaneGame(String type)
	{
