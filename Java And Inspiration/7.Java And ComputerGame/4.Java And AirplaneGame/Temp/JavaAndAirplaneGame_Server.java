...
import java.net.*;
import java.io.*;
public class JavaAndAirplaneGame_Server
{
	public static void main(String[] args)
	{
		new JFrame_AirplaneGame_Server();
	}
}
class JFrame_AirplaneGame_Server extends JFrame implements KeyListener,MouseListener,MouseMotionListener
{
	...
	public JFrame_AirplaneGame_Server()
	{
