...
public class JavaAndVirtualMachine3D
{
	public static void main(String[] args)
	{
		...
		Image iconImage=null;try{iconImage=ImageIO.read(new File("VirtualMachineIcon.jpg"));}catch(Exception e){}
		MainFrame MainFrame1=new MainFrame(virtualMachine3D,400,400);
		MainFrame1.setIconImage(iconImage);
	}
}
...
class SyntaxTranslator
{
	...
	private String getArithmeticIdentifierValue()
	{
		...
		{
			String id0="&"+(identifierNumber++);
			this.index++;
			String id1=this.getArithmeticIdentifierValue();
