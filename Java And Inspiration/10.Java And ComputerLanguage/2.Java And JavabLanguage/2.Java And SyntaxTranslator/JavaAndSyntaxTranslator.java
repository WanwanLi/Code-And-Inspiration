...
public class JavaAndSyntaxTranslator
{
	public static void main(String[] args)
	{
		...
		SyntaxTranslator1.generateVirtualMachineInstructions("test");
	...
	private static String getCode(String fileName)
	{
		...
		try
		{
			BufferedReader BufferedReader1=new BufferedReader(new FileReader(fileName+".javab"));
...
class SyntaxTranslator
{
				...
				else if(thisMethod.equals("fillPolygon"))
				{
					...
					else if(w0==Word.KEY&&w1==WordList.Key_new)
					{
						...
						if(w0==Word.KEY&&w1==WordList.Key_int)
						{
							...
							int startPointer=this.getArrayAssignmentInstructions(id);
	...
	private int getArrayAssignmentInstructions(int id)
	{
		this.nextWord();
		if(w0==Word.MRK&&w1==Word.L_SQRBRACKET)
		{
