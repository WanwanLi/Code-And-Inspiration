...
class Architecture1 extends TransformGroup
{
	...
	TransformGroup getSouthWallSolarBattery()
	{
		...
		for(int i=0;i<3;i++)
		{
			for(int j=0;j<5;j++)
			{
				...
				double z=width+0.0180/2*cosA;
				double rotX=A-Math.PI/2;
				double rotY=0;
				double rotZ=0;
		...
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(0+0.0711/2+dx,0+0.132/2+dy,width+0.132/2*cosA+dz),A-Math.PI/2,0,Math.PI/2));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(0+0.0711/2+dx,0.132+0.132/2+dy,width+0.132/2*cosA+dz),A-Math.PI/2,0,Math.PI/2));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(0+0.0711+0.132/2+dx,0+0.0711/2+dy,width+0.0711/2*cosA+dz),A-Math.PI/2,0,0));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(0+0.0711+0.132+0.132/2+dx,0+0.0711/2+dy,width+0.0711/2*cosA+dz),A-Math.PI/2,0,0));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(0.35-0.0711/2+dx,0.132+0.0711/2+dy,width+0.132/2*cosA+dz),A-Math.PI/2,0,Math.PI/2));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(length-0.132/2+dx,0+0.0711/2+dy,width+0.0711/2*cosA+dz),A-Math.PI/2,0,0));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(length-0.132/2+dx,height-0.0711/2+dy,width+0.0711/2*cosA+dz),A-Math.PI/2,0,0));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(length-0.132-0.132/2+dx,height-0.0711/2+dy,width+0.0711/2*cosA+dz),A-Math.PI/2,0,0));
		southWallSolarBattery.addChild(new SolarBattery("C2",new Point3d(length-0.0711/2+dx,height-0.0711-0.132/2+dy,width+0.132/2*cosA+dz),A-Math.PI/2,0,Math.PI/2));
	...
	TransformGroup getRoofSolarBattery()
	{
		...
		for(int i=0;i<9;i++)
		{
			...
			double y=height+(0.651153-0.092/2)*sinW+0.092/2*sinA;
			...
			y=height+(0.651153-0.092-0.0818/2)*sinW+0.092/2*sinA;
		...
		for(int i=0;i<4;i++)
		{
			...
			double y=height+(0.3357-0.1645/2)*sinW+0.1645/2*sinA;
			...
			y=height+(0.3357-0.1645-0.1645/2)*sinW+0.1645/2*sinA;
		...
		for(int i=0;i<9;i++)
		{
			...
			double y=height+(0.6511-i*0.0711-0.0711/2)*sinW+0.0711/2*sinA;
		...
		for(int i=0;i<3;i++)
		{
			for(int j=0;j<3;j++)
			{
				...
				double y=height+(0.651153-i*0.14-0.14/2)*sinW+0.14/2*sinA;
		...
		{
			double x=0.1645/2;
			double y=height+(i*0.072+0.072/2)*sinW+0.072/2*sinA;
		...
		y=height+(0.3357-0.1645-0.0818/2)*sinW+0.0818/2*sinA;
		z=width-(0.3357-0.1645-0.0818/2)*cosW;
		roofSolarBattery.addChild(new SolarBattery("C10",new Point3d(x+dx,y+dy,z+dz),rotX,rotY,rotZ));
		y=height+(0.3357-0.1645-0.0818-0.0818/2)*sinW+0.0818/2*sinA;
